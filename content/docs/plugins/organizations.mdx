...
| ----------- | ---------------------------------- | ------------------------- | -------------------------------- |
| `POST`      | `/organizations`                   | Create organization       | `organizations:create`           |
| `GET`       | `/organizations`                   | List user's organizations | `organizations:list`             |
...
| `POST`      | `/organizations/{organization_id}/invitations/{invitation_id}/accept` | Accept invitation | `organizations:invitations:process`      |
| `POST`      | `/organizations/{organization_id}/invitations/{invitation_id}/reject` | Reject invitation | `organizations:invitations:process`      |
